...
import type { MutiraoRelatorio, RegistroRelatorio, RevitalizacaoRelatorio, DDSRelatorio, Relatorio } from "@/lib/types";
...
export default function RelatorioDetalhePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function handleExportPdf() {
    ...
    try {
      ...
      let exportType: 'unified' | 'mutirao' | 'evidencias' | 'monumentos' = 'unified';
