...
import { Relatorio, MutiraoRelatorio, RegistroRelatorio, RevitalizacaoRelatorio, DDSRelatorio, MonumentosRelatorio, EventosRelatorio, FotoEtapa, SubRegiao } from "@/lib/types";
