        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col justify-end">
            <Link 
              ...
              className="bg-indigo-600 hover:bg-indigo-500 hover:from-indigo-600 hover:to-purple-700 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
            >
